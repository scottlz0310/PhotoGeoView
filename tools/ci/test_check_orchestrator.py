...
from ci.models import CheckTask, CheckStatus
...
def test_dependency_resolver():
    ...
    tasks = [
        ...
        CheckTask(name="task_c", check_type="security_scanner", dependencies=["task_a"]),
        CheckTask(name="task_d", check_type="performance_analyzer", dependencies=["task_b", "task_c"]),
    ]
...
def test_task_filtering():
    ...
    try:
        ...
        tasks = [
            ...
            CheckTask(name="test_check", check_type="test_runner", dependencies=["quality_check"]),
            CheckTask(name="security_check", check_type="security_scanner", dependencies=[]),
        ]
