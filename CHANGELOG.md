...
### Fixed
- Windows auto-update download link now matches the generated installer filename (`artifactName` aligned with `latest.yml`).

## [2.2.0] - 2025-12-18

### Added
- Windows packaging now generates `build/icon.ico` from `assets/icon.png` during `pnpm package`.

### Fixed
- Windows ICO conversion now preserves alpha transparency.
- Windows taskbar/window icon now correctly uses the app icon.
...
[2.2.1]: https://github.com/scottlz0310/PhotoGeoView/compare/v2.2.0...v2.2.1
[2.2.0]: https://github.com/scottlz0310/PhotoGeoView/compare/v2.1.9...v2.2.0
[2.1.9]: https://github.com/scottlz0310/PhotoGeoView/compare/v2.1.8...v2.1.9
