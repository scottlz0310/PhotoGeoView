...
- [x] ユニットテスト <!-- 2026-01-01完了 -->
  - [x] コンポーネントテスト (React Testing Library) <!-- 2026-01-01完了 -->
  - [x] カスタムフックテスト (該当なし) <!-- 2026-01-01完了 -->
  - [x] Zustand Storeテスト <!-- 2026-01-01完了 -->
- [x] E2Eテスト (Playwright + Tauri) <!-- 2026-01-01完了 -->
  - [x] 写真読み込みフロー
  - [x] 地図操作
  - [ ] エクスポート (未実装)
- [x] カバレッジ計測設定 (Codecov) <!-- 2026-01-01完了 -->
  - [x] フロントエンド (Vitest + Playwright + nyc) <!-- 2026-01-01完了 -->
  - [x] バックエンド (tarpaulin) <!-- 2026-01-01完了 -->

#### バックエンド

- [x] Rustユニットテスト (`cargo test`) <!-- 2026-01-01完了 -->
  - [x] EXIF読み取りテスト
  - [x] 画像処理テスト
  - [x] エラーハンドリングテスト
- [x] カバレッジ計測 (tarpaulin) <!-- 2026-01-01完了 -->
...
- [x] Windows用ビルド設定 <!-- 2026-01-01完了 -->
  - [x] NSIS設定 (Tauriデフォルト)
  - [x] アイコン (icon.ico) <!-- 2025-12-31完了 -->
- [x] macOS用ビルド設定 <!-- 2026-01-01完了 -->
  - [x] DMG設定 (Tauriデフォルト)
  - [x] アイコン (icon.icns) <!-- 2025-12-31完了 -->
- [x] Linux用ビルド設定 <!-- 2026-01-01完了 -->
  - [x] AppImage設定 (Tauriデフォルト)
...
- [x] GitHub Actions設定 <!-- 2025-12-31完了 -->
  ...
  - [x] CIでのカバレッジ合算確認 <!-- 2026-01-01完了 -->
- [x] クロスプラットフォームビルド確認 <!-- 2026-01-01完了 -->
  - [x] Windows (x64)
...
- [x] バージョン番号確定 (v3.0.0) <!-- 2026-01-01完了 -->
- [x] リリースノート作成 (CHANGELOG.md更新) <!-- 2026-01-01完了 -->
- [x] スクリーンショット・デモGIF作成 <!-- 2026-01-01完了 -->
- [x] GitHub Release作成 <!-- 2026-01-01完了 -->
...
- [x] Windows/macOS/Linuxで正常にビルド可能 <!-- 2026-01-01完了 -->
- [x] 100枚の写真を3秒以内に読み込み可能 <!-- 2026-01-01完了 (仮想スクロール実装済み) -->
- [x] 基本機能（ファイル選択、EXIF読み取り、地図表示、写真表示）が動作 <!-- 2026-01-01完了 -->
- [x] テストカバレッジ: フロントエンド70%以上、バックエンド80%以上 <!-- 2026-01-01完了 -->
- [x] ドキュメントが整備されている <!-- 2026-01-01完了 -->
