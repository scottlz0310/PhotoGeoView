...
def test_logging_integration():
    ...
    with tempfile.TemporaryDirectory() as temp_dir:
        ...
        service.configure_logging(
            debug_enabled=True, performance_logging_enabled=True, log_level="DEBUG"
        )
        ...
        service.log_detailed_debug_info(
            "test_operation",
            {
        ...
        service.log_performance_metrics(
            "test_performance",
            {
                "duration": 1.5,
                "files_processed": 100,
        ...
        try:
            ...
            service.log_error_details(
                "test_error",
                e,
                {"context_info": "テストコンテキスト", "operation_stage": "testing"},
            )

        # Test appropriate level logging
        print("6. ログレベル別出力テスト...")
        service.log_with_appropriate_level(
            "INFO", "test_info", "情報レベルのテストメッセージ"
        )
        service.log_with_appropriate_level(
            "WARNING",
            "test_warning",
        ...
        service.log_with_appropriate_level(
            "ERROR", "test_error_level", "エラーレベルのテストメッセージ"
        )
