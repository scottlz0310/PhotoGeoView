...
def verify_theme_functionality():
    ...
    try:
        ...
        print("\n📈 テスト結果:")
        print(
            f"  成功したテーマ切り替え: {successful_switches}/{len([t for t in test_themes if t in available_themes])}"
        )
        ...
        print("\n🎉 検証完了!")
        print(
            f"💡 VIEWメニューから{len(available_themes)}個のテーマを選択できるはずです"
        )
